...
import { deleteCode, editCode, getAllCodes, getMyCodes, loadCode, saveCode, } from "../controllers/compiler.controller";
...
router.route("/fetch-code").get(verifyJWT, getMyCodes);
